...
namespace SHBT.Ui
{
    ...
    public static class Localization
    {
                ...
                private static readonly Dictionary<string, string> EmbeddedEnUs = new Dictionary<string, string>
        {
            ...
            ["app_desc"] = "Hot backup for Siemens WinCC / Step7 / TIA Portal projects using VSS volume shadow copy. No downtime, one-click backup.",
            ["no_label"] = "(No label)",
            ["mode_label"] = "Run mode: ",
            ["mode_admin"] = "Administrator",
            ["mode_user"] = "Standard user (limited)",
            ["exclude_add_row"] = "Add rule row",
            ["last_backup"] = "Last backup:",
            ["disclaimer"] = "⚠ Test before use; you bear all risks.",
            ["warn_save"] = "Please save all edits in progress, and close all WinCC windows except the runtime screen and Manager, to ensure all changes are stored.",
            ["log_target_file"] = "Target file: {0}",
            ["warn_7zip_warning"] = "7-Zip exited with warnings (code 1): the archive may be incomplete. Check the log.",
